  ...
  <div class="container marketing  mt-5">
    ...
    <div class="row">
      <div class="col-lg-4">
        ...
        <p><a class="btn btn-secondary" href="productos.php" role="button">Ver celulares</a></p>
      </div><!-- /.col-lg-4 -->
      ...
      <div class="col-lg-4">
        ...
        <p><a class="btn btn-secondary" href="productos.php" role="button">Ver notebooks</a></p>
      </div><!-- /.col-lg-4 -->
      ...
      <div class="col-lg-4">
        ...
        <p><a class="btn btn-secondary" href="productos.php" role="button">Ver tablets</a></p>
      </div><!-- /.col-lg-4 -->
    </div><!-- /.row -->
